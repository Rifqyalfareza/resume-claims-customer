            ...
            <tbody>
                ...
                <?php foreach ($parts as $part) : ?>
                    <tr class="hover:bg-gray-50 dark:hover:bg-gray-800 cursor-pointer">
                        <td class="font-medium text-gray-900 whitespace-nowrap dark:text-white text-center"><?= $no++ ?></td>
                        <td class="part font-medium text-gray-900 whitespace-nowrap dark:text-white"><?= $part['part_name'] ?></td>
