        ...
        <div class="relative bg-white rounded-lg shadow-sm dark:bg-gray-700">
            ...
            <form class="p-4 md:p-5" method="post">
                <div class="grid gap-6 mb-4 grid-cols-2">
                    ...
                    <div class="col-span-2">
                        <div class="relative">
                            <input type="text" name="singkatan" id="singkatan" style="text-transform:uppercase" class="block px-2.5 pb-2.5 pt-4 w-full text-sm text-gray-900 bg-transparent rounded-lg border-1 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer" placeholder=" " required/>
                    ...
                    <div class="col-span-2">
                        <div class="relative">
                            <input type="text" name="alamat" id="alamat" style="text-transform:uppercase" class="block px-2.5 pb-2.5 pt-4 w-full text-sm text-gray-900 bg-transparent rounded-lg border-1 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer" placeholder=" " required/>
